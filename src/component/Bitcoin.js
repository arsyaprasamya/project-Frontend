                ...
                <div className="panel panel-default" style={{marginTop:80}}>
                    ...
                    <div className="panel-body">
                        ...
                        <div className="text-justify">
                            *Catatan: Jika data pada tabel tidak muncul, harap untuk di-reload atau tunggu hingga datanya muncul. Anda juga dapat mengeceknya di console, jika sudah muncul datanya di console, maka data akan ter-load di tabel
                        </div>
                    </div>
                </div>
            </div>
